...
This tool is designed to be a secure, self-contained HTML file with no external dependencies. The following third-party libraries have been downloaded and included locally in the `js/` directory.
